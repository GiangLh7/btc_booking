...
class AutoSuggestion {
  ...
  initialize() {
    ...
    Utils.addEvent(window, 'resize', this.updateSuggestionContainer.bind(this));
  
    // delegate suggestion item's event
    Utils.delegateEvent("autocomplete-suggestion", "mouseup", (selectedSuggestion, e) => {
      if (selectedSuggestion) {
          let val = selectedSuggestion.getAttribute('data-val');
  ...
  destroy () {
    Utils.removeEvent(window, 'resize', this.updateSuggestionContainer);
    Utils.removeEvent(this.element, 'blur', this.onInputBlur);
    Utils.removeEvent(this.element, 'focus', this.onInputFocus);
    Utils.removeEvent(this.element, 'keydown', this.onInputKeyDown);
    Utils.removeEvent(this.element, 'keyup', this.onInputKeyUp);
    document.body.removeChild(this.suggestionContainer);
  };
}
...
class AppsSuggestion extends AutoSuggestion{
  constructor(element, options) {
    ...
    this.options.dataSource = (term, callback) => {
